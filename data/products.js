const products = [
  ...
  {
    name: 'Addidas shoe 121v2 TWS Earbuds',
  ...
  {
    name: 'Dell laptop 121v2 TWS Earbuds',
    image: '/images/dell.jpg',
    description:
      'deLl laptop 121v2 TWS Earbuds with  V5.0,  Up to 14H Total Playback, Instant Voice Assistant, Easy Access Controls with Mic and Dual Tone Ergonomic Design(Active Black) ',
    brand: 'Dell',
    category: 'Electronics',
    price: 20.99,
    countInStock: 10,
